...
public class LTapHai extends RecyclerView.Adapter<LTapHai.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public LTapHai(MyData[] myData, LuyenTapHai activity){
    ...
    @NonNull
    @Override
    public LTapHai.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.luyen_hai,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull LTapHai.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            radio5a.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    radio5a.setTextColor(Color.parseColor("#00FF04"));
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("LuyenTapHai", MODE_PRIVATE);
