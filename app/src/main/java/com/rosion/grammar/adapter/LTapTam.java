...
public class LTapTam extends RecyclerView.Adapter<LTapTam.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public LTapTam(MyData[] myData, LuyenTapTam activity){
    ...
    @NonNull
    @Override
    public LTapTam.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.layout_tam,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull LTapTam.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("LuyenTapTam", MODE_PRIVATE);
