...
public class LTapBay extends RecyclerView.Adapter<LTapBay.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public LTapBay(MyData[] myData, LuyenTapBay activity){
    ...
    @NonNull
    @Override
    public LTapBay.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.layout_bay,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull LTapBay.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            radio1a.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    radio1b.setTextColor(Color.parseColor("#00FF04"));
            ...
            radio3a.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    radio3a.setTextColor(Color.parseColor("#00FF04"));
            ...
            radio6a.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    radio6d.setTextColor(Color.parseColor("#00FF04"));
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("LuyenTapBay", MODE_PRIVATE);
