...
public class HapHienTaiTD extends RecyclerView.Adapter<HapHienTaiTD.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public HapHienTaiTD(MyData[] myData, HienTaiTD activity){
    ...
    @NonNull
    @Override
    public HapHienTaiTD.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.httd_layout,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull HapHienTaiTD.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("HienTaiTD", MODE_PRIVATE);
