...
public class LTapBa extends RecyclerView.Adapter<LTapBa.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public LTapBa(MyData[] myData, LuyenTapBa activity){
    ...
    @NonNull
    @Override
    public LTapBa.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.luyen_ba,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull LTapBa.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            radio12a.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    radio12d.setTextColor(Color.parseColor("#00FF04"));
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("LuyenTapBa", MODE_PRIVATE);
