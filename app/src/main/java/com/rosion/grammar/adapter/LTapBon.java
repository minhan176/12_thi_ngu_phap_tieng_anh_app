...
public class LTapBon extends RecyclerView.Adapter<LTapBon.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public LTapBon(MyData[] myData, LuyenTapBon activity){
    ...
    @NonNull
    @Override
    public LTapBon.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.layout_tu,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull LTapBon.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            radio8a.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    radio8a.setTextColor(Color.parseColor("#00FF04"));
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("LuyenTapBon", MODE_PRIVATE);
