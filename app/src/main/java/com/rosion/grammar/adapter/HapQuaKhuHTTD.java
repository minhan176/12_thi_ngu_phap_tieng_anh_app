...
public class HapQuaKhuHTTD extends RecyclerView.Adapter<HapQuaKhuHTTD.ViewHolder> {

    MyData[] myData;
    Context context;
    //Context ListAdapter context SharedPreferences
    public HapQuaKhuHTTD(MyData[] myData, QuaKhuHTTD activity){
    ...
    @NonNull
    @Override
    public HapQuaKhuHTTD.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.qkhttd_layout,parent,false);
        ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(@NonNull HapQuaKhuHTTD.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public void saveData() {
            SharedPreferences sharedPreferences = context.getSharedPreferences("QuaKhuHTTD", MODE_PRIVATE);
